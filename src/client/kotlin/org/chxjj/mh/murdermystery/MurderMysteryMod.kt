...
import org.chxjj.murdermystery.MurderMysterySwordDetection
...
object MurderMysteryMod {
    ...
    fun initialize() {
        ...
        ClientPlayConnectionEvents.JOIN.register(ClientPlayConnectionEvents.Join { _: ClientPacketListener, _: PacketSender, _: ClientLevel ->
            reset()
        })
        ...
        ClientPlayConnectionEvents.RESPAWN.register(ClientPlayConnectionEvents.Respawn { _: ClientPacketListener, _: PacketSender, _: ClientLevel ->
            reset()
        })
    }
    ...
    private fun renderDroppedBows(context: WorldRenderContext) {
        val level = mc.level ?: return
